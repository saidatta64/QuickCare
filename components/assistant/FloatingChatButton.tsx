...
export default function FloatingChatButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 chat-container">
      {isOpen ? (
        <div className="w-full max-w-sm h-[600px] bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 flex flex-col overflow-hidden transition-all duration-300 transform origin-bottom-right">
        ...
        <Button 
          ...
          variant="primary"
          size="lg"
          className="rounded-full w-14 h-14 p-0 flex items-center justify-center shadow-lg hover:shadow-xl transition-all hover:scale-105"
